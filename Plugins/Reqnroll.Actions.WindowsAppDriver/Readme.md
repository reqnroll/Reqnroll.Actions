# Reqnroll.Actions.WindowsAppDriver

[![Nuget](https://img.shields.io/nuget/v/Reqnroll.Actions.WindowsAppDriver)](https://www.nuget.org/packages/Reqnroll.Actions.WindowsAppDriver/)

This Reqnroll.Action will help you use Windows App Driver together with Reqnroll. It handles the lifetime of the Windows App Driver, and the Appium instance created to interact with the application.
...
You can configure this plugin by adding a json file into your project named `reqnroll.actions.json`. Set the file as 'content' and to 'copy if newer'.
...
``` json
{
  "windowsAppDriver": {
    "capabilities": {
      "app": "../ReqnrollCalculator/bin/Debug/net5.0-windows/ReqnrollCalculator.exe"
    },
...
Add the latest version of the `Reqnroll.Actions.WindowsAppDriver` NuGet Package to your project.

Latest version: [![Nuget](https://img.shields.io/nuget/v/Reqnroll.Actions.WindowsAppDriver)](https://www.nuget.org/packages/Reqnroll.Actions.WindowsAppDriver/)
