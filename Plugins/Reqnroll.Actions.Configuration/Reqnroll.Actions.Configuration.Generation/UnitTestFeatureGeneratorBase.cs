...
namespace Reqnroll.Actions.Configuration.Generation
{
    public abstract class UnitTestFeatureGeneratorBase : IFeatureGenerator
    {
        ...
        public UnitTestFeatureGeneratorBase(IUnitTestGeneratorProvider testGeneratorProvider, CodeDomHelper codeDomHelper, ReqnrollConfiguration reqnrollConfiguration, IDecoratorRegistry decoratorRegistry)
        {
        ...
        public CodeNamespace GenerateUnitTestFixture(ReqnrollDocument document, string testClassName, string targetNamespace)
        {
            ...
            testClassName = testClassName ?? string.Format(TestClassNameFormat, reqnrollFeature.Name.ToIdentifier());
            ...
            _unitTestMethodGenerator.CreateUnitTests(reqnrollFeature, generationContext);
